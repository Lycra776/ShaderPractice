    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                UNITY_DEFINE_INSTANCED_PROP( float, _node_2347)
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float _node_2347_var = UNITY_ACCESS_INSTANCED_PROP( Props, _node_2347 );
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*_node_2347_var,1) );
                return o;
            }
