...
Shader "AP01/Lession1/Jade1" {
    Properties {
        ...
        _node_7257 ("node_7257", Range(0, 1)) = 0.3004697
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Lighting:
////// Emissive:
                float node_5213 = (dot(i.normalDir,lightDirection)*0.5+0.5);
                float3 emissive = float3(node_5213,node_5213,node_5213);
